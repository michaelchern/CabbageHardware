...
},{"FragmentShader_E__CabbageFramework_SourceCode_CabbageGlobalContext_h_192_63",
...
},{"VertexShader_E__CabbageFramework_SourceCode_CabbageGlobalContext_h_199_61",
ShaderCodeModule(R"(ByteAddressBuffer bonesMatrix[] : register(t2, space0);
struct UniformBufferObject_1
{
    row_major float4x4 viewProjMatrix;
...
},{"FragmentShader_E__CabbageFramework_SourceCode_CabbageGlobalContext_h_199_61",
ShaderCodeModule(R"(struct UniformBufferObject_1
{
    row_major float4x4 viewProjMatrix;
};
...
},{"ComputeShader_E__CabbageFramework_SourceCode_CabbageGlobalContext_h_208_53",
...
},{"ComputeShader_E__CabbageFramework_SourceCode_CabbageGlobalContext_h_211_56",
